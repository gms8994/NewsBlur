...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.premium_start_date'
        db.add_column('profile_profile', 'premium_start_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.premium_end_date'
        db.add_column('profile_profile', 'premium_end_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.premium_cancel_date'
        db.add_column('profile_profile', 'premium_cancel_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.premium_start_date'
        db.delete_column('profile_profile', 'premium_start_date')

        # Deleting field 'Profile.premium_end_date'
        db.delete_column('profile_profile', 'premium_end_date')

        # Deleting field 'Profile.premium_cancel_date'
        db.delete_column('profile_profile', 'premium_cancel_date')
    ...
    models = {
        ...
        'profile.profile': {
            ...
            'premium_cancel_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'premium_end_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'premium_start_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
